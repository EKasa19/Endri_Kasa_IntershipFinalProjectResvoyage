...
public class WaitUtils {
    ...
    public Boolean waitForElementInvisibilityWithCustomTime(long mills, WebElement element){
    ...
    public WebElement waitForVisibilityOfElementRefreshedCustomTime(long mills, WebElement element){
        WebDriverWait wait = new WebDriverWait(driver, mills);
